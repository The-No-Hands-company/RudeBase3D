...
MaterialPtr Material::createDefault()
{
    ...
    material->setDiffuseColor(glm::vec4(0.8f, 0.8f, 0.8f, 1.0f));  // Bright gray diffuse
    material->setSpecularColor(glm::vec4(0.2f, 0.2f, 0.2f, 1.0f)); // Subtle specular
    material->setAmbientColor(glm::vec4(0.3f, 0.3f, 0.3f, 1.0f));  // Strong ambient for visibility
...
{
    auto material = std::make_shared<Material>();
    material->setDiffuseColor(glm::vec4(0.7f, 0.7f, 0.8f, 1.0f));
...
{
    auto material = std::make_shared<Material>();
    material->setDiffuseColor(glm::vec4(0.8f, 0.2f, 0.2f, 1.0f));
    material->setSpecularColor(glm::vec4(0.8f, 0.8f, 0.8f, 1.0f));
    material->setAmbientColor(glm::vec4(0.2f, 0.05f, 0.05f, 1.0f));
...
{
    auto material = std::make_shared<Material>();
    material->setDiffuseColor(glm::vec4(0.9f, 0.9f, 0.9f, 0.3f));
    material->setSpecularColor(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f));
    material->setAmbientColor(glm::vec4(0.1f, 0.1f, 0.1f, 1.0f));
